...
export const buscarTodosAnuncios = () => http.get('/anuncios/v1?page=0&size=2')

export const buscarAnuncios = (rua, bairro, cidade) => http.get(`/anuncios/v1/search?rua=${rua}&bairro=${bairro}&cidade=${cidade}&page=0&size=2`)
